...
public class TrendingsEBooksAdapter extends RecyclerView.Adapter<TrendingsEBooksAdapter.ViewHolder> {
    ...
    List<HomePageResponse.TrendingeBook> mValues = new ArrayList<HomePageResponse.TrendingeBook>();
    Context mContext;
    ...
    @Override
    public TrendingsEBooksAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
    ...
    public interface ItemListener {
        void onItemClick(HomePageResponse.TrendingeBook item, int currposition);
    }
}