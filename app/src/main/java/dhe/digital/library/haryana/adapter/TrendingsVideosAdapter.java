...
public class TrendingsVideosAdapter extends RecyclerView.Adapter<TrendingsVideosAdapter.ViewHolder> {
    ...
    List<HomePageResponse.TrendingVideo> mValues = new ArrayList<HomePageResponse.TrendingVideo>();
    Context mContext;
...
//                    imageView.setController(controller);
    ...
    @Override
    public TrendingsVideosAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
    ...
    public interface ItemListener {
        void onItemClick(HomePageResponse.TrendingVideo item, int currposition);
    }
}