...
public class TrendingsJournalsAdapter extends RecyclerView.Adapter<TrendingsJournalsAdapter.ViewHolder> {
    ...
    List<HomePageResponse.TrendingJournal> mValues = new ArrayList<HomePageResponse.TrendingJournal>();
    Context mContext;
...
//                    imageView.setController(controller);
    ...
    @Override
    public TrendingsJournalsAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
    ...
    public interface ItemListener {
        void onItemClick(HomePageResponse.TrendingJournal item, int currposition);
    }
}