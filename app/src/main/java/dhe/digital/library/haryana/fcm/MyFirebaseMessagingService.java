package dhe.digital.library.haryana.fcm;
...
import dhe.digital.library.haryana.ui.splash.SplashActivity;
import dhe.digital.library.haryana.utility.Config;
import dhe.digital.library.haryana.utility.App_Preference;
...
//        Log.e("From: ", remoteMessage.getData().get("sendername"));
        ...
        app_preference = new App_Preference(getApplicationContext());
