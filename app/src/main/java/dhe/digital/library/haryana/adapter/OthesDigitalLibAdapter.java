...
public class OthesDigitalLibAdapter extends RecyclerView.Adapter<OthesDigitalLibAdapter.ViewHolder> {
    ...
    public OthesDigitalLibAdapter(Context context, List values, ItemListener itemListener) {
    ...
    @Override
    public OthesDigitalLibAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
